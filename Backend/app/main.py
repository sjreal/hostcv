...
async def match(
    ...
    for cv_entry in cvs:
        ...
        age_filter_required = jd_obj.age_filter and (jd_obj.age_filter.min_age is not None or jd_obj.age_filter.max_age is not None)
        gender_filter_required = jd_obj.gender_filter and jd_obj.gender_filter.lower() != 'any' and jd_obj.gender_filter.strip() != ''
        if age_filter_required:
        ...
        if filter_status["passed"] and gender_filter_required:
        ...
        if not age_filter_required and not gender_filter_required:
            filter_status = {"passed": True, "reason": "No age or gender filter required by JD."}
